        ...
        const homeHTML = `
            <div class="navbar">
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="#" id="signup-link"><i class="fas fa-user-plus"></i> Sign Up</a></li>
                </ul>
            </div>
            <div class="container">
        ...
        const dashboardHTML = `
            <div class="navbar">
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="#" id="community-link"><i class="fas fa-users"></i> Community</a></li>
        ...
        const sectionHTML = `
            ...
            <div class="container">
                <div class="notes-header">
                    ...
                    <button class="btn" id="upload-note"><i class="fas fa-upload"></i> Upload New Note</button>
                </div>
                ...
                <div class="search-bar">
                    ...
                    <button class="btn btn-outline" id="reset-search"><i class="fas fa-redo"></i> Reset</button>
                </div>
        ...
        if (dropArea && fileInput) {
            ...
            fileInput.addEventListener('change', (e) => {
                if (fileInput.files.length > 0) {
                    ...
                    dropArea.innerHTML = `<i class="fas fa-file-alt"></i><p>${fileInput.files[0].name}</p>`;
                } else {
            ...
            dropArea.addEventListener('drop', (e) => {
                ...
                if (files.length > 0) {
                    ...
                    dropArea.innerHTML = `<i class="fas fa-file-alt"></i><p>${files[0].name}</p>`;
                }
            }, false);
        }
    ...
    checkAuth().then(async user => {
        ...
        const communityHTML = `
            <div class="navbar">
                ...
                <ul class="nav-links">
                    <li><a href="#" id="dashboard-link"><i class="fas fa-home"></i> Dashboard</a></li>
                    <li><a href="#" id="community-link" class="active"><i class="fas fa-users"></i> Community</a></li>
                    <li><a href="#" id="logout-link"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
                </ul>
            </div>
            <div class="container">
                    ...
                    <div class="post-form">
                        ...
                        <form id="post-form">
                            <div class="form-group">
                                ...
                                <textarea id="post-content" class="form-control" rows="4" placeholder="Share something with your class..." required></textarea>
                            </div>
                                    ...
                                    <div class="post-replies" id="replies-${post.id}" style="display: none;">
                                        ...
                                        <div class="reply-form" id="reply-form-${post.id}">
                                            <form class="post-reply-form" data-post-id="${post.id}">
                                                <div class="form-group">
                                                    <textarea class="form-control reply-text" placeholder="Write your reply..." required></textarea>
                                                </div>
